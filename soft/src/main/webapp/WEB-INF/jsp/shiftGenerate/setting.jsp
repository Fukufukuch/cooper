...
<div class="container">
  ...
  <div class="card" style="margin-top:24px;">
    ...
    <form action="<%= request.getContextPath() %>/shiftGenerate/confirm" method="post" style="margin-top:20px;">
      ...
      <div class="form-group">
        <label>生成日数</label>
        <input type="number" name="generateDays" value="7" class="form-control" required>
      </div>

      <div class="form-group">
        <label>月最大労働時間（分）</label>
        <input type="number" name="maxWorkMonth" value="8000" class="form-control" required>
      </div>

      <div class="form-group">
        <label>日最大労働時間（分）</label>
        <input type="number" name="maxWorkDay" value="720" class="form-control" required>
      </div>

      <div class="form-group">
        <label>新人判定時間（分）</label>
        <input type="number" name="newcomerMinutes" value="5000" class="form-control" required>
      </div>

      <div class="form-group">
        <label>必要ベテラン人数</label>
        <input type="number" name="seniorRequired" value="1" class="form-control" required>
      </div>
