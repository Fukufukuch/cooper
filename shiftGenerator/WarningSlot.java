...
public class WarningSlot {
    ...
    private final List<Integer> warningWorkers;  // 警告対象の従業員IDリスト
    private final WarningType warningType;       // 警告タイプ

    public WarningSlot(LocalDate date, TimeSlot timeSlot, Position position, int nonconformTag, List<Integer> warningWorkers, WarningType warningType) {
        this.date = date;
    ...
    public List<Integer> getWarningWorkers() {
